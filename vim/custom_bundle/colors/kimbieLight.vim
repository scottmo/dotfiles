" simple light colorscheme modified from nova.vim
" maintained by Shaocong Mo

hi clear
syntax reset
let g:colors_name='kimbieLight'
set background=light

" Default Color Definitions
let s:foreground	= "#4d6a79"
let s:background	= "#fbebd5"

let s:light_grey	= "#f6d7b7"
let s:normal_grey	= "#e6c8ab"
let s:dark_grey		= "#a89984"
