...
#   Now I assume your external hard-disk name is "Mantosh Harddisk".
# diskutil info /Volumes/Mantosh Harddisk
# sudo vi /etc/fstab
#   write the below line in this file.
#       LABEL=Mantosh\040Harddisk none ntfs rw,auto,nobrowse
#       \040 is for space in hard-disk name.
#       (if LABEL is not supported in your system, you can use UUID=NUMBER none
#       ntfs rw,auto,nobrowse)
#   Quit Terminal and Now, just unmount and re-mount the disk.
